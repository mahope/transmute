...
**Status:** I GANG — slice 1 til 7 færdige (`14dce0b`, `599ca4f`, `a4114ca`, `8a161fb`, `bb19768`, `c446d37` og `c1bee9f`). Slice 8 (`actions/setup-node` v6 → v7) er færdig i dette commit og lukker hele action-sættet. Den næste slice er `ubuntu-latest` → `ubuntu-26.04` med egen commit.
**Mislykkede forsøg:** 0/2

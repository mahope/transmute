...
**Status:** I GANG — slice 1, 2 og 3 færdige (`14dce0b`, `599ca4f` og slice 3 i dette commit). Slice 4+ er de otte action-majors, én pr. commit.
**Mislykkede forsøg:** 0/2
...
| # | Fra → til | Filer | Noter |
|---|---|---|---|
| 3 | `actions/checkout` v4 → v5 | `ci.yml`, `publish.yml` | **Færdig** (dette commit). `homebrew-bump.yml` bruger ingen actions |
| 4 | `actions/setup-node` v4 → v5 | `ci.yml`, `publish.yml` | Næste iteration. Hæv `setup-node`-gulvet til 5 i samme commit |

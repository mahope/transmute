...
**Deploy-status ⚠️ (genverificeret 2026-09-26 ca. 19:0x, starten på T50-iterationen):** uændret for **fjortende** gang i træk. Live er `3d90812` (2026-09-24 23:32:50 +0200), 5 site-commit i drift, 25 afvigende filer, `/support/index.html` utilgængelig. Se `❓ Til Mads` punkt 1.
